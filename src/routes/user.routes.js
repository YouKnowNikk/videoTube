...
import { changePassword, getUserChannelProfile, getUserWatchhistory, refreshAccessToken, updateAvatar, updateProfile, userLogin, userLogout, userRegistration } from "../controllers/user.controller.js";
...
router.route("/history").get(verifyUser,getUserWatchhistory)
